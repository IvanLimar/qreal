...
/// Ensures that a diagram may be correctly generated into russian C code.
class TrikRussianCControlFlowValidator : public generatorBase::PrimaryControlFlowValidator
{
public:
	TrikRussianCControlFlowValidator(const qrRepo::RepoApi &repo
